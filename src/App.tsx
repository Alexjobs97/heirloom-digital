...
const IconDB      = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="22" height="22"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>;
...
function BottomNav() {
  ...
  const items = [
    ...
    { to: "/ingredienti", label: locale === "ja" ? "栄養・DB" : "Nutrizione",  Icon: IconDB    },
  ];
